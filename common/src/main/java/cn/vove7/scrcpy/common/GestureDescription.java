...
public final class GestureDescription {
    ...
    public static class Builder {
         ...
         */
        public @NonNull
        Builder setDisplayId(int displayId) {
            mDisplayId = displayId;
            return this;
        }
    ...
    public static class TouchPoint implements Parcelable {
        ...
        Parcelable.Creator<TouchPoint> CREATOR
    ...
    public static class GestureStep implements Parcelable {
        ...
        public String toString() {
            return "GestureStep{" +
                    "timeSinceGestureStart=" + timeSinceGestureStart +
                    ", numTouchPoints=" + numTouchPoints +
                    ", touchPoints=" + Arrays.toString(touchPoints) +
                    '}';
        }
        ...
        public static final @NonNull
        Parcelable.Creator<GestureStep> CREATOR
